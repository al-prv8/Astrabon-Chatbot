...
import {
  ...
  ArrowRight, UtensilsCrossed, Martini,
  Bed, Sparkles, Layers
} from 'lucide-react';

const CATEGORIES = [
  // ─── Primary 6 (always visible) ─────────────────────────────────────
  {
    id: 'cookware',
    label: 'Cookware & Sets',
  ...
  },
  {
    id: 'glassware',
    label: 'Glassware',
    description: 'Premium crystal, wine glasses, and drinkware',
    icon: Wine,
  ...
  },
  {
    id: 'buffet',
    label: 'Buffet Ware',
    description: 'Chafing dishes, serving equipment, and presentation',
    icon: Utensils,
    image: '/categories/buffet.png',
  ...
  },
  {
    ...
    icon: Building2,
    image: '/categories/industrial.png',
    prompt: 'I need industrial kitchen equipment',
    accent: 'from-stone-500/20 to-neutral-500/10',
  },

  // ─── Secondary 5 (expandable) ───────────────────────────────────────
  {
    id: 'kitchenware',
    label: 'Kitchenware & Accessories',
    description: 'Utensils, spatulas, ladles, and kitchen tools',
    icon: UtensilsCrossed,
    image: '/categories/kitchenware.png',
    prompt: 'Show me kitchenware and accessories',
    accent: 'from-emerald-500/20 to-green-500/10',
  },
  {
    id: 'porcelain',
    label: 'Porcelain & Dinnerware',
    description: 'Fine dining plates, bowls, and serving sets',
    icon: Sparkles,
    image: '/categories/porcelain.png',
    prompt: 'Show me porcelain and dinnerware',
    accent: 'from-purple-500/20 to-indigo-500/10',
  },
  {
    id: 'cutlery',
    label: 'Cutlery',
    description: 'Dining forks, knives, spoons — everyday to fine dining',
    icon: Layers,
    image: '/categories/cutlery.png',
    prompt: 'Show me cutlery options',
    accent: 'from-zinc-500/20 to-gray-500/10',
  },
  {
    id: 'restaurant-bar',
    label: 'Restaurant & Bar Accessories',
    description: 'Cocktail tools, service stations, and bar essentials',
    icon: Martini,
    image: '/categories/bar.png',
    prompt: 'Show me bar accessories',
    accent: 'from-rose-500/20 to-pink-500/10',
  },
  {
    id: 'housekeeping',
    label: 'Housekeeping & Room Appliances',
    description: 'Cleaning supplies, laundry carts, kettles, and minibars',
    icon: Bed,
    image: '/categories/housekeeping.png',
    prompt: 'Show me housekeeping supplies',
