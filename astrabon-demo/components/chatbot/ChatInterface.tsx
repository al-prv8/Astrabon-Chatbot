...
import { generateBotResponse, DEMO_SCRIPT } from '@/data/chat-scripts';
              ...
              <div className="flex flex-wrap gap-2 mt-2 pl-9">
                {msg.options.map(opt => (
                  <button
                    ...
                    className="px-3 py-1.5 rounded-full bg-surface-alt/60 border border-border-subtle text-xs text-text-secondary hover:bg-primary hover:text-text-on-primary hover:border-primary transition-all duration-300"
                  >
                    {opt}
                  </button>
                ))}
